...
class Ui_sap(object):
    def setupUi(self, sap):
        ...
        self.tabMain.setGeometry(QtCore.QRect(10, 0, 561, 391))
        ...
        self.grpInput.setGeometry(QtCore.QRect(0, 0, 541, 191))
        ...
        self.cmbTrsJenis = QtGui.QComboBox(self.grpInput)
        self.cmbTrsJenis.setGeometry(QtCore.QRect(130, 90, 401, 24))
        self.cmbTrsJenis.setObjectName(_fromUtf8("cmbTrsJenis"))
        ...
        self.dateTrsTanggal.setGeometry(QtCore.QRect(130, 120, 110, 23))
        ...
        self.cmbCariJenis = QtGui.QComboBox(self.grpCari)
        self.cmbCariJenis.setEnabled(False)
        self.cmbCariJenis.setGeometry(QtCore.QRect(130, 90, 371, 24))
        self.cmbCariJenis.setObjectName(_fromUtf8("cmbCariJenis"))
        ...
        self.dateCariTanggal.setGeometry(QtCore.QRect(130, 180, 110, 23))
        ...
        self.rbtCariJenis = QtGui.QRadioButton(self.grpCari)
        self.rbtCariJenis.setGeometry(QtCore.QRect(10, 90, 97, 20))
        self.rbtCariJenis.setObjectName(_fromUtf8("rbtCariJenis"))
        self.rbtCariTanggal = QtGui.QRadioButton(self.grpCari)
        self.rbtCariTanggal.setGeometry(QtCore.QRect(10, 180, 97, 20))
        ...
        self.cmbCariDebet.setGeometry(QtCore.QRect(130, 120, 371, 24))
        self.cmbCariDebet.setObjectName(_fromUtf8("cmbCariDebet"))
        self.rbtCariDebet = QtGui.QRadioButton(self.grpCari)
        self.rbtCariDebet.setGeometry(QtCore.QRect(10, 120, 97, 20))
        ...
        self.cmbCariKredit.setGeometry(QtCore.QRect(130, 150, 371, 24))
        self.cmbCariKredit.setObjectName(_fromUtf8("cmbCariKredit"))
        self.rbtCariKredit = QtGui.QRadioButton(self.grpCari)
        self.rbtCariKredit.setGeometry(QtCore.QRect(10, 150, 97, 20))
        ...
        self.grpEdit.setGeometry(QtCore.QRect(0, 0, 541, 231))
        ...
        self.cmbEditJenis = QtGui.QComboBox(self.grpEdit)
        self.cmbEditJenis.setGeometry(QtCore.QRect(130, 130, 401, 24))
        self.cmbEditJenis.setObjectName(_fromUtf8("cmbEditJenis"))
        self.label_8 = QtGui.QLabel(self.grpEdit)
        self.label_8.setGeometry(QtCore.QRect(30, 130, 101, 21))
        ...
        self.dateEditTanggal.setGeometry(QtCore.QRect(130, 160, 110, 23))
        ...
        self.btnEditDelete.setGeometry(QtCore.QRect(120, 200, 85, 26))
        ...
        self.actionMain_Data_as_Table = QtGui.QAction(sap)
        self.actionMain_Data_as_Table.setObjectName(_fromUtf8("actionMain_Data_as_Table"))
        self.actionMain_Data_as_CSV = QtGui.QAction(sap)
        self.actionMain_Data_as_CSV.setObjectName(_fromUtf8("actionMain_Data_as_CSV"))
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionExit)
        self.menuFile.addAction(self.actionAbout)
        self.menuView.addAction(self.actionMain_Data_as_Table)
        self.menuView.addAction(self.actionMain_Data_as_CSV)
    ...
    def retranslateUi(self, sap):
        ...
        self.label_2.setText(_translate("sap", "Jenis Transaksi", None))
        ...
        self.rbtCariJenis.setText(_translate("sap", "Jenis", None))
        ...
        self.label_8.setText(_translate("sap", "Jenis Transaksi", None))
        ...
        self.actionMain_Data_as_Table.setText(_translate("sap", "Main Data as Table", None))
        self.actionMain_Data_as_CSV.setText(_translate("sap", "Main Data as CSV", None))
